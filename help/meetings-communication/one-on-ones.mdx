...
<Info>
  One‑on‑ones are your **most important recurring meeting** as a manager.
  They're where coaching, trust, and early risk detection actually happen.
</Info>
...
<Tip>
  **Stay close to reality** Hear about risks, blockers, and morale before they
  show up in metrics.
</Tip>
...
<Tip>
  **Protect the time** – cancel only when absolutely necessary, and reschedule
  quickly.
</Tip>
