  ...
  return (
    <div className='p-6 space-y-8'>
      <div>
        ...
        <p className='text-muted-foreground'>Run data reports and view recent runs</p>
      </div>
      ...
      <section className='space-y-3'>
        ...
        <ul className='space-y-2'>
          {reports.map(r => (
            <li key={r.codeId} className='flex items-center justify-between border rounded p-3'>
              <div>
