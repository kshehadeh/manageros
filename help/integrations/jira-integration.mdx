...
<Info>
  Organization-level integrations allow all organization members to link their Jira accounts. User-level integrations are also available in **Settings** → **Integrations** for personal use.
</Info>
