...
import { linkUserToPerson, unlinkUserFromPerson, getAvailableUsersForLinking } from '@/lib/actions'
      ...
      {linkedUser ? (
        <div className="bg-green-50 border border-green-200 rounded-lg p-4">
          <div className="flex items-center justify-between">
            <div>
              <div className="font-medium text-green-800">Linked to User Account</div>
        ...
        <form onSubmit={handleLink} className="space-y-4">
          <div>
            <label className="block text-sm font-medium mb-2">Select User to Link</label>
            <select
            ...
            {availableUsers.length === 0 && (
              <p className="text-sm text-neutral-500 mt-1">
                No available users to link. All users in your organization are already linked to persons.
              </p>
            )}
          </div>
