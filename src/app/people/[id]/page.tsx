      ...
      <div className='grid gap-6 md:grid-cols-2'>
            ...
            <div>
              ...
              <div className='text-sm text-neutral-400'>
                {personWithRelations.startedAt
                  ? new Date(personWithRelations.startedAt).toLocaleDateString()
                  : 'Not specified'}
              </div>
            </div>
            <div>
        ...
        <section className='card'>
          <div className='flex items-center justify-between mb-4'>
            ...
            <Link
              href={`/people/new?managerId=${personWithRelations.id}`}
      ...
      <div className='grid gap-6 md:grid-cols-2'>
        ...
        <section className='card'>
          <div className='flex items-center justify-between mb-4'>
            ...
            <Link
              href={`/initiatives/new?ownerId=${personWithRelations.id}${
                personWithRelations.team
            ...
            <div className='space-y-3'>
              ...
              {personWithRelations.oneOnOnesAsManager.length > 0 && (
                <div>
                  <div className='text-sm font-medium mb-2'>
                    As Manager ({personWithRelations.oneOnOnesAsManager.length})
                  </div>
              ...
              {personWithRelations.oneOnOnes.length > 0 && (
                <div>
                  ...
                  {personWithRelations.oneOnOnes.slice(0, 2).map(oneOnOne => (
                    <div
                      key={oneOnOne.id}
                      className='border border-neutral-800 rounded-xl p-3 mb-2'
                    >
      ...
      <section className='card'>
        ...
        <div className='grid grid-cols-2 md:grid-cols-4 gap-4'>
          ...
          <div className='text-center'>
            ...
            <div className='text-sm text-neutral-400'>Owned Initiatives</div>
          </div>
          <div className='text-center'>
            <div className='text-2xl font-bold'>
