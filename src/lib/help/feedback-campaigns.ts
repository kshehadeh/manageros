...
Feedback campaigns help you **collect structured input from the right people at the right time** – for performance reviews, 360s, and quick “pulse” checks.

Used well, they turn scattered opinions into actionable insights for growth.

---

## Overview

A feedback campaign in mpath is a **focused cycle of feedback about a specific person**:
...
- End‑of‑cycle performance feedback
- Pulse surveys on engagement or collaboration

---

## Why Feedback Campaigns Matter (Benefits)

- **Richer, multi‑source perspective**  
  See how someone shows up for their manager, peers, and reports – not just one direction.

- **More objective performance decisions**  
  Calibrations and promotions can be grounded in broad input, not only hallway opinions.

- **Regular signals on team health**  
  Pulse campaigns surface issues early so you can act before they become attrition.
...
### Performance review campaigns

Use for:

- End‑of‑cycle evaluations
- Documenting progress against goals and expectations
- Feeding into formal review and calibration processes

These often combine:

- Rating scales aligned to your competency framework
- Free‑text questions for examples and recommendations

### Pulse surveys

Use for:

- Quick reads on engagement, psychological safety, or process changes
- Testing how a reorg, new process, or leadership change is landing

They are:

- Short, focused, and frequent enough to spot trends.

---

## How to Run a Feedback Campaign (Step‑by‑Step)
...
2. Decide on **anonymity**:
   - Fully anonymous for sensitive or broad feedback.
...
### Example: Post‑reorg pulse

- Target: Multiple people across a team or org.
- Purpose: Understand how the reorg is landing after 4–6 weeks.
- Questions:
  - Clarity of responsibilities.
  - Communication quality.
  - Where people are blocked or confused.
- Outcome:
  - Concrete actions to improve communication and clarify ownership.
