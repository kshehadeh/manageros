...
const badgeVariants = cva(
  'inline-flex items-center rounded-full border px-lg py-xs text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 whitespace-nowrap',
  {
    variants: {
      variant: {
        default:
